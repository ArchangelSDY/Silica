...
elseif (WIN32)
    ...
    install(FILES "${OPENSSL_ROOT_DIR}/lib/libeay32.dll" DESTINATION . COMPONENT applications)
    install(FILES "${OPENSSL_ROOT_DIR}/lib/ssleay32.dll" DESTINATION . COMPONENT applications)
